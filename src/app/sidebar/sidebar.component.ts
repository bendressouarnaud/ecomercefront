...
export const routesSuperviseurMairie: RouteInfo[] = [
    {
        path: '/superviseur/accueilman',
        title: 'Accueil',
        type: 'link',
        icontype: 'dashboard'
    },
    {
        ...
        type: 'sub',
        icontype: 'apps',
        collapse: 'superviseur',
        children: [
            { path: 'clientman', title: 'Clients', ab: 'CS' },
            { path: 'magasin', title: 'Recouvrement', ab: 'RT' },
            { path: 'location', title: 'Location', ab: 'RV' },
            { path: 'stats', title: 'Statistiques', ab: 'AG' }
        ]
    }
];
...
export const routesSuperAdministarteur: RouteInfo[] = [
    {
        path: '/superadmin',
        title: 'Gestion',
        type: 'sub',
...
export class SidebarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        switch (localStorage.getItem("profil")) {
            ...
            case "superviseur":
                this.menuItems = routesSuperviseurMairie.filter(menuItem => menuItem);
                break;
